...
import YourAccountTooltip from "../components/homepage/navigation/YourAccountTooltip";
const MainNav = () => {
        ...
        <nav className={styles.mainNav}>
            <ul className={styles.navList}>
                ...
                <div className={styles.rightNav}>
                    ...
                    <li className={styles.item}>
                        <Link to="/create-advertisement" className={`${styles.link} ${styles.createAdvertisement}`}>
